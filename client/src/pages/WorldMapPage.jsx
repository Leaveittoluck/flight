      ...
      <header className="litl-page-header">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-7 sm:py-9">
          <div className="flex items-center gap-3">
            <Link
              to="/stats"
              className="text-sm text-slate-500 hover:text-slate-800 transition-colors duration-150 shrink-0"
            >
              ← Stats
            </Link>
            <span className="w-px h-4 bg-orange-200" />
            <div>
              <h1 className="text-3xl font-bold text-slate-900 tracking-tight">World Map</h1>
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-3 px-6 py-3 transition-colors duration-100 ${
                      isActive ? 'bg-blue-50' : 'hover:bg-orange-50/30'
                    }`}
                  >
