      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 sm:p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-semibold text-stone-900 mt-4 mb-1">Start exploring</h1>
            <p className="text-sm text-stone-500">Create your account — it's free</p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <p className="text-center text-xs text-stone-400 leading-relaxed">
              ...
              <span className="text-stone-600 cursor-pointer hover:text-amber-600 transition-colors">
                Terms
              </span>{' '}
              and{' '}
              <span className="text-stone-600 cursor-pointer hover:text-amber-600 transition-colors">
